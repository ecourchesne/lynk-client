...
const formSchema = z.object({
    ...
    companyId: z.string().min(1, 'Select a decoder.'),
})

const CommercialForm = () => {
    const { addCommercialClient } = useClientStore()
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
        ...
        const { success, error } = await addCommercialClient({ email: data.email, companyId: Number(data.companyId) })
